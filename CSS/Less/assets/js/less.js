...
!(function (e, t) {
  ...
  B.prototype = Object.assign(new u(), {
    type: "Comment",
    genCSS: function (e, t) {
      this.debugInfo && t.add(U(e, this), this.fileInfo(), this.getIndex()),
        t.add(this.value);
    },
    isSilent: function (e) {
    ...
    eval: function (e) {
      ...
      if (e.isMathOn(this.op)) {
        if (
          ...
          if (i instanceof ie && "/" === i.op && e.math === te.PARENS_DIVISION)
                    ...
                    (o.processImports = !1),
                      ...
                      s.isPlugin
                        ...
                        : !a.files[i] ||
                          ...
                          s.multiple
                        ? new Be(o, a, c).parse(r, function (e, t) {
                            u(e, t, i);
                          })
